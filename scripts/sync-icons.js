...
const ICON_MAP = {
  ...
  'queries/no-pure-renotes': { pack: 'lucide', name: 'repeat' },
  'queries/keyword-mute': { pack: 'lucide', name: 'volume-x' },
  'queries/media-only': { pack: 'lucide', name: 'image' },
  'queries/local-only': { pack: 'lucide', name: 'map-pin' },
  'queries/calm-timeline': { pack: 'lucide', name: 'coffee' },
  'queries/bot-mute': { pack: 'lucide', name: 'bot-off' },
