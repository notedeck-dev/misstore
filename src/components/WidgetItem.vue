...
<template>
  <router-link :to="localePath(`/widgets/${widget.id}`)" class="vsx-card vsx-card-link">
    <div class="vsx-body">
      ...
      <div class="vsx-details">
        <div class="vsx-name">{{ itemText(widget).name }}</div>
        ...
        <p class="vsx-desc">{{ itemText(widget).description }}</p>
      </div>
    </div>
